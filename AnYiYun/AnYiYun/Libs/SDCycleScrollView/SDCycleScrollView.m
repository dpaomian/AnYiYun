...
@interface SDCycleScrollView () <UICollectionViewDataSource, UICollectionViewDelegate,SDWebImageManagerDelegate>
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_imageContentsGroup.count && itemIndex < _imageContentsGroup.count) {
        cell.addtionString = _imageContentsGroup[itemIndex];
    }
