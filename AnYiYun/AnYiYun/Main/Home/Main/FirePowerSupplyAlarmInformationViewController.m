//
//  FirePowerSupplyAlarmInformationViewController.m
//  AnYiYun
//
...
@interface FirePowerSupplyAlarmInformationViewController ()

@end

@implementation FirePowerSupplyAlarmInformationViewController
...
//    NSString *urlString = [NSString stringWithFormat:@"%@rest/firePower/alarm",@"http:101.201.108.240:18084/Android/"];
