//
//  FirePowerSupplyEquipmentManagementRootViewController.m
//  AnYiYun
//
...
@interface FirePowerSupplyEquipmentManagementRootViewController ()

@end

@implementation FirePowerSupplyEquipmentManagementRootViewController

- (void)viewDidLoad {
    [super viewDidLoad];
        
    __weak FirePowerSupplyEquipmentManagementRootViewController *ws = self;
    ...
    _reminderVC = [[FirePowerSupplyMaintenanceRemindersViewController alloc] initWithNibName:NSStringFromClass([FirePowerSupplyMaintenanceRemindersViewController class]) bundle:nil];
    [_reminderVC.view setFrame:CGRectMake(0.0f, 44.0f, SCREEN_WIDTH, CGRectGetHeight(self.view.frame)-44.0f)];
    _accountVC = [[FirePowerSupplyEquipmentAccountViewController alloc] initWithNibName:NSStringFromClass([FirePowerSupplyEquipmentAccountViewController class]) bundle:nil];
