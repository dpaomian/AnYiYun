...
@implementation MessageMaintainCell
...
{
    [_cellDelegate repairButtonActionWithItem:_useModel];
}
    //曲线
-(void)curveButtonAction:(id)sender
{
    [_cellDelegate curveButtonActionWithItem:_useModel];
}
    //定位
-(void)locationAction:(id)sender
{
    [_cellDelegate locationActionWithItem:_useModel];
}
...
{
    if (!_leftImgView) {
        _leftImgView = [[UIImageView alloc]initWithFrame:CGRectMake(10, 10, 30, 30)];
...
{
    if (!_titleLabel) {
        _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(50, 0, SCREEN_WIDTH-160, 40)];
...
{
    if (!_dealButton) {
        _dealButton = [[JXLayoutButton alloc] initWithFrame:CGRectMake(0, 71, SCREEN_WIDTH/4, 39)];
...
{
    if (!_repairButton) {
        _repairButton = [[JXLayoutButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/4, 71, SCREEN_WIDTH/4, 39)];
        ...
        [_repairButton setImage:[UIImage imageNamed:@"main_test.png"] forState:UIControlStateNormal];
        _repairButton.layoutStyle = JXLayoutButtonStyleUpImageDownTitle;
...
{
    if (!_curveButton) {
        _curveButton = [[JXLayoutButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/4*2, 71, SCREEN_WIDTH/4, 39)];
        ...
        [_curveButton setImage:[UIImage imageNamed:@"main_test.png"] forState:UIControlStateNormal];
        _curveButton.layoutStyle = JXLayoutButtonStyleUpImageDownTitle;
...
{
    if (!_locationButton) {
        _locationButton = [[JXLayoutButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/4*3, 71, SCREEN_WIDTH/4, 39)];
        ...
        [_locationButton setImage:[UIImage imageNamed:@"main_test.png"] forState:UIControlStateNormal];
        _locationButton.layoutStyle = JXLayoutButtonStyleUpImageDownTitle;
...
{
    if (!_dealLineLabel) {
        _dealLineLabel = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/4, 75, 0.5, 30)];
...
{
    if (!_repairLineLabel) {
        _repairLineLabel = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/4*2, 75, 0.5, 30)];
...
{
    if (!_curveLineLabel) {
        _curveLineLabel = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/4*3, 75, 0.5, 30)];
