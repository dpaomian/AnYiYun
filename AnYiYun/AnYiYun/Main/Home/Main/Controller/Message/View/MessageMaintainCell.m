...
{
    [_cellDelegate dealMaintainButtonActionWithItem:_useModel];
}
    //报修
-(void)repairButtonAction:(id)sender
{
    [_cellDelegate repairMaintainButtonActionWithItem:_useModel];
}
    //曲线
-(void)curveButtonAction:(id)sender
{
    [_cellDelegate curveMaintainButtonActionWithItem:_useModel];
}
    //定位
-(void)locationAction:(id)sender
{
    [_cellDelegate locationMaintainActionWithItem:_useModel];
}
