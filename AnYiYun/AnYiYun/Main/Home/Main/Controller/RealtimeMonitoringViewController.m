...
- (void)viewDidLoad {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:NSStringFromClass([RealtimeMonitoringChildSwitchCell class]) bundle:nil] forCellReuseIdentifier:@"RealtimeMonitoringChildSwitchCell"];
