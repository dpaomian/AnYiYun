//
//  SafetyMonitoringRootViewController.m
//  AnYiYun
//
...
@interface SafetyMonitoringRootViewController ()

@end

@implementation SafetyMonitoringRootViewController

- (void)viewDidLoad {
    [super viewDidLoad];
        
    __weak SafetyMonitoringRootViewController *ws = self;
